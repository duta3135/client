...
function SplitActionBtn() {
    ...
    return (
        <div className={styles.wrapper}>
            <button className={styles.mainBtn}>Post to site</button>
            <button className={styles.btnDown} onClick={console.log('clicked')}>
            ...
            <div className={dropdownStyle}>Save to drafts</div>
        </div>
    )
}
